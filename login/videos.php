...
<body class="videos-page">
    ...
    <form method="post">
        ...
        <input type="text" name="add_title" placeholder="Video Title" required>
        <input type="text" name="add_url" placeholder="Video URL" required>
        <textarea name="add_description" placeholder="Video Description"></textarea>
